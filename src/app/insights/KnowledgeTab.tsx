...
import {
    Search, Filter, BookOpen, Brain, TrendingUp,
...
export default function KnowledgeTab() {
    ...
    return (
        <div className={`bg-[var(--color-bg-dark)] ${isFullscreen ? 'fixed inset-0 z-50' : ''}`}>
            {/* Stats Bar */}
                ...
                {graphData.nodes.length === 0 && !knowledgeLoading ? (
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                        ...
                        <div className="flex gap-3">
                            <Link href="/forge" className="px-4 py-2 text-sm rounded-lg bg-[var(--color-green)]/20 text-[var(--color-green)] border border-[var(--color-green)]/30 hover:bg-[var(--color-green)]/30 transition-colors">
                                WordForge →
                            </Link>
                            <Link href="/journal?tab=edge" className="px-4 py-2 text-sm rounded-lg bg-[var(--color-blue)]/20 text-[var(--color-blue)] border border-[var(--color-blue)]/30 hover:bg-[var(--color-blue)]/30 transition-colors">
                                Slight Edge →
                            </Link>
                        </div>
                    </div>
