...
import {
    Calendar, Loader2, RefreshCw, Network,
            ...
            <div className="relative" style={{ height: isFullscreen ? '100vh' : 'calc(100vh - 140px)' }}>
                ...
                {graphData.nodes.length === 0 && !knowledgeLoading ? (
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
                        ...
                        <Link href="/journal?tab=edge" className="px-4 py-2 text-sm rounded-lg bg-[var(--color-green)]/20 text-[var(--color-green)] border border-[var(--color-green)]/30 hover:bg-[var(--color-green)]/30 transition-colors">
                                ...
                                <div className="mb-4">
                                    ...
                                    <div className="flex flex-wrap gap-1.5">
                                        {selectedDayData.node.conceptsLearned.map((c, i) => (
                                            <Link
                                                key={i}
                                                href={`/insights?tab=knowledge&trace=${encodeURIComponent(c.replace(/\s+/g, '-').replace(/[^a-z0-9-]/g, ''))}`}
